...
DModule((char*)"64 channels digitizer 62.5MHz",(char*)"CAEN v1740D",mdesc,addr) {
    ...
    for(UInt_t i = 0; i < 64; i++)  m_SelfTriggerMaskDPP[i] = 0;
...
//            m_StringBuffer1 +=  to_string(get<0>(pEventQueue.top())) + " "  + to_string(get<1>(pEventQueue.top()) ) + " " +to_string(get<2>(pEventQueue.top())) + "\n";
            ...
            m_StringBuffer1 +=  to_string(get<2>(pEventQueue.top())) + " "  + to_string(m_ModuleID) + " " + to_string(get<0>(pEventQueue.top()) ) + " " +to_string(get<1>(pEventQueue.top())) + "\n";
            //     cout << m_StringBuffer1 << endl;
            pEventQueue.pop();
        }
...
void DCAEN1740D::DataSave(DAcquisition *fAcquisition){
    ...
    //std::cout << "[DEBUG] 1 DCAEN1740D::DataSave m_EmptyBuffer = "<< fAcquisition->m_EmptyBuffer << std::endl;
    ...
    if( m_saveAfterSize || m_saveAfterTime || fAcquisition->m_EmptyBuffer){
        std::cout << "[DEBUG] 4 DCAEN1740D::DataSave m_EmptyBuffer = "<< fAcquisition->m_EmptyBuffer << std::endl;
        char nr[256];
