...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::ReadData*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("ReadData", ::ReadData::Class_Version(), "ReadData.h", 12,
...
void Files::Streamer(TBuffer &R__b)
{
   ...
   if (R__b.IsReading()) {
      R__b.ReadClassBuffer(Files::Class(),this);
   } else {
      R__b.WriteClassBuffer(Files::Class(),this);
   }
}
...
namespace ROOT {
   static TClass *vectorlEAEventmUgR_Dictionary();
   static void vectorlEAEventmUgR_TClassManip(TClass*);
   static void *new_vectorlEAEventmUgR(void *p = 0);
   static void *newArray_vectorlEAEventmUgR(Long_t size, void *p);
   static void delete_vectorlEAEventmUgR(void *p);
   static void deleteArray_vectorlEAEventmUgR(void *p);
   static void destruct_vectorlEAEventmUgR(void *p);

   // Function generating the singleton type initializer
   static TGenericClassInfo *GenerateInitInstanceLocal(const vector<AEvent*>*)
   {
      vector<AEvent*> *ptr = 0;
      static ::TVirtualIsAProxy* isa_proxy = new ::TIsAProxy(typeid(vector<AEvent*>));
      static ::ROOT::TGenericClassInfo 
         instance("vector<AEvent*>", -2, "vector", 210,
                  typeid(vector<AEvent*>), ::ROOT::Internal::DefineBehavior(ptr, ptr),
                  &vectorlEAEventmUgR_Dictionary, isa_proxy, 0,
                  sizeof(vector<AEvent*>) );
      instance.SetNew(&new_vectorlEAEventmUgR);
      instance.SetNewArray(&newArray_vectorlEAEventmUgR);
      instance.SetDelete(&delete_vectorlEAEventmUgR);
      instance.SetDeleteArray(&deleteArray_vectorlEAEventmUgR);
      instance.SetDestructor(&destruct_vectorlEAEventmUgR);
      instance.AdoptCollectionProxyInfo(TCollectionProxyInfo::Generate(TCollectionProxyInfo::Pushback< vector<AEvent*> >()));
      return &instance;
   }
   // Static variable to force the class initialization
   static ::ROOT::TGenericClassInfo *_R__UNIQUE_(Init) = GenerateInitInstanceLocal((const vector<AEvent*>*)0x0); R__UseDummy(_R__UNIQUE_(Init));

   // Dictionary for non-ClassDef classes
   static TClass *vectorlEAEventmUgR_Dictionary() {
      TClass* theClass =::ROOT::GenerateInitInstanceLocal((const vector<AEvent*>*)0x0)->GetClass();
      vectorlEAEventmUgR_TClassManip(theClass);
   return theClass;
   }
...
namespace ROOT {
   // Wrappers around operator new
   static void *new_vectorlEAEventmUgR(void *p) {
      return  p ? ::new((::ROOT::Internal::TOperatorNewHelper*)p) vector<AEvent*> : new vector<AEvent*>;
   }
   static void *newArray_vectorlEAEventmUgR(Long_t nElements, void *p) {
      return p ? ::new((::ROOT::Internal::TOperatorNewHelper*)p) vector<AEvent*>[nElements] : new vector<AEvent*>[nElements];
   }
   // Wrapper around operator delete
   static void delete_vectorlEAEventmUgR(void *p) {
      delete ((vector<AEvent*>*)p);
   }
   static void deleteArray_vectorlEAEventmUgR(void *p) {
      delete [] ((vector<AEvent*>*)p);
   }
   static void destruct_vectorlEAEventmUgR(void *p) {
      typedef vector<AEvent*> current_t;
      ((current_t*)p)->~current_t();
   }
} // end of namespace ROOT for class vector<AEvent*>
...
class __attribute__((annotate(R"ATTRDUMP(class to read and keep in vector actual data in memory)ATTRDUMP"))) __attribute__((annotate("$clingAutoload$ReadData.h")))  ReadData;
)DICTFWDDCLS";
