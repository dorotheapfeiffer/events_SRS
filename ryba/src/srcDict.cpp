...
#define R__DICTIONARY_FILENAME srcDict
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::MainWindow*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("MainWindow", ::MainWindow::Class_Version(), "MainWindow.h", 42,
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::UserClass*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("UserClass", ::UserClass::Class_Version(), "invalid", 17,
...
nullptr};
    ...
    if (!isInitialized) {
      TROOT::RegisterModule("srcDict",
        headers, includePaths, payloadCode, fwdDeclCode,
        TriggerDictionaryInitialization_srcDict_Impl, {}, classesHeaders);
      isInitialized = true;
    }
  }
  static struct DictInit {
    DictInit() {
      TriggerDictionaryInitialization_srcDict_Impl();
    }
  } __TheDictionaryInitializer;
}
void TriggerDictionaryInitialization_srcDict() {
  TriggerDictionaryInitialization_srcDict_Impl();
}
