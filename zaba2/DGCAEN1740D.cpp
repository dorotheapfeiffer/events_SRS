...
//===========================================================
 ...
 ClassImp(DGCAEN1740D)

//-----------------------------------------------------------------------------
 DGCAEN1740D::DGCAEN1740D(DModule *module) : DGModule((DModule *) module) {

  std::cout << "constructing DGCAEN1740D" << std::endl;
 ...
 MapWindow();
 Refresh();
 std::cout << "constructing DGCAEN1740D done!" << std::endl;
...
//-----------------------------------------------------------------------------
 DGCAEN1740D::~DGCAEN1740D() {
  
  //DGCAEN1740D *dCAEN1740 = (DGCAEN1740D *) fModule;
  //dCAEN1740->dGMadc32 = 0;
  std::cout <<"destroying DGCAEN1740DD" << std::endl;
  //delete fL0;

}
//-----------------------------------------------------------------------------
 void DGCAEN1740D::Refresh() {
  // Update GUI so it represents the actual contents of fModule.
  // 
  DCAEN1740 *dCAEN1740 = (DCAEN1740 *) fModule;

  std::cout << " DGCAEN1740D refresh button status " << std::endl;
...
//-----------------------------------------------------------------------------
 Bool_t DGCAEN1740D::HandleTimer(TTimer *tim) {
  return kTRUE;
}
//-----------------------------------------------------------------------------
 Bool_t DGCAEN1740D::ProcessMessage(Long_t msg, Long_t parm1, Long_t parm2){
	  ...
	  if(parm1 == eGPIO){
       ...
       case kCM_COMBOBOX:
	     ...
	     dCAEN1740->m_ExtTriggerMode = static_cast<UInt_t>(parm2);	  
            ...
            std::cerr << "ERROR [DGCAEN1740D::ProcessMessage] in text enter parm1: " << parm1 << std::endl;
       ...
       case kCM_CHECKBUTTON:
         if(parm1 >= eSaveChannel && parm1 < eSaveChannel + 64)
            ...
            std::cerr << "ERROR [DGCAEN1740D::ProcessMessage] in CheckButton parm1: " << parm1 << std::endl;
       break;
       default:
       break;
      }
